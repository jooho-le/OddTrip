...
import { LoadState, PageHeading, Pagination, Panel, StatusPill, TableShell, formatDate, tdClass, thClass } from '../ui';
    ...
    <>
      ...
      <Panel>
        <form
          ...
          onSubmit={(event) => { event.preventDefault(); setOffset(0); setApplied(query); }}
        >
        ...
        {trips.data?.items.length ? (
          <>
            ...
            <Pagination offset={offset} limit={pageSize} total={trips.data.total} onChange={setOffset} />
          </>
        ) : null}
      </Panel>
    </>
